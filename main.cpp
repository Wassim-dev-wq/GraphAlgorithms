                ...
                if (choix == 'y')
                {
                    ...
                    if (nbArrets != 0)
                    {
                        ...
                        while (i < nbArrets)
                        {
                            ...
                            {
                                cout << "\nLe sommet " << s2 << " n'éxiste pas en graph, veuillez entrer une sommet valide "
...
int main()
{
    ...
    do
    {
        ...
        case '1':
            ...
            cout << "1 : Choix 1. Plus de détail sur un graph ? [MARCHE PAS]" << endl;
            ...
            if (choix == '1')
            {
                ...
                while (true)
                {
                    ...
                    else
                    {
                        ...
                        cout << "1.Modifier sur le graph[MARCHE PAS]" << endl;
